...
Le gestionnaire de collisions est représenté grâce à la classe \texttt{CollisionManager}. C'est cette classe qui va gérer toutes les collisions du \texttt{plugin}, que ce soit les personnages et les munitions, les munitions et les murs ou bien le champs de vision de ennemis.
