...
\usepackage{textpos} % allows to place stuff differently
...
\begin{textblock*}{100mm}(.751\textwidth,-1cm)
\includegraphics[height=9mm]{logo_shine.png} \hspace{1mm} \includegraphics[height=9mm]{logo-ufc.png}
\end{textblock*}}
...
\AtBeginSection[]
{
  ...
  \small \tableofcontents[currentsection, hideothersubsections, pausesubsections]
  \end{frame} 
}
